...
#SBATCH --output="/expanse/lustre/projects/ddp412/kakamatsu/working_err/MAGEPRO_genoa_target_random_resid.%j.%N.out"
#SBATCH --error="/expanse/lustre/projects/ddp412/kakamatsu/working_err/MAGEPRO_genoa_target_random_resid.%j.%N.err"
...
\
--out /expanse/lustre/projects/ddp412/kakamatsu/MAGEPRO_REVIEWS3/GENOA_target/random/out_norandom_scale_redo \
