...
#SBATCH -J sims_newld
#SBATCH -A csd832
#SBATCH -o /expanse/lustre/projects/ddp412/kakamatsu/working_err/sims_newld.%j.%N.out
#SBATCH -e /expanse/lustre/projects/ddp412/kakamatsu/working_err/sims_newld.%j.%N.err
#SBATCH --export=ALL
